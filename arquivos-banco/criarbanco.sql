...
CREATE INDEX date_s_index ON artworks (date_start);
CREATE INDEX date_e_index ON artworks (date_end);
...
CREATE OR REPLACE VIEW show_artworks AS
SELECT
...
CREATE ROLE "User";
GRANT SELECT ON show_artworks, show_artworks TO "User";
