...
def load_departments():
    print("Carregando tabela 'departments'...")
    ...
    for page in range(1, total_pages + 1):
        ...
        for department in departments:
            ...
            if status != "sucesso":
                print("Erro ao inserir departamento de id: " + str(department.id))
        if page < total_pages:
            request = requests.get(request["pagination"]["next_url"]).json()


def load_artwork_types():
    print("Carregando tabela 'artwork_types'...")
    ...
    for page in range(1, total_pages + 1):
        ...
        for artwork_type in artwork_types:
            ...
            if status != "sucesso":
                print("Erro ao inserir tipo de arte de id: " + str(artwork_type.id))
        if page < total_pages:
            request = requests.get(request["pagination"]["next_url"]).json()


def load_categories():
    print("Carregando tabela 'categories'...")
    ...
    for page in range(1, total_pages + 1):
        ...
        for category in categories:
            ...
            if status != "sucesso":
                print("Erro ao inserir categoria de id: " + str(category.id))
        if page < total_pages:
            request = requests.get(request["pagination"]["next_url"]).json()


def load_artists():
    print("Carregando tabela 'artists'...")
    ...
    for page in range(1, total_pages + 1):
        ...
        for artist in artists:
            ...
            if status != "sucesso":
                print("Erro ao inserir artista de id: " + str(artist.id))
        if page < total_pages:
            request = requests.get(request["pagination"]["next_url"]).json()


def load_artworks():
    print("Carregando tabela 'artworks'...")
    ...
    for page in range(1, total_pages + 1):
        ...
        for artwork in artworks:
            ...
            if status != "sucesso":
                print("Erro ao inserir arte de id: " + str(artwork_to_insert.id))
            ...
            for category in artwork["category_ids"]:
                ...
                if status != "sucesso":
                    print(
                        "Erro ao inserir categoria de arte de id: "
